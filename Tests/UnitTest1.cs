...
namespace Tests
{
    public class Tests
    {
        ...
        {
            form = new Form1();
            form.Form1_Load(null, EventArgs.Empty); // Инициализируем форму
        }
        ...
        public void MoveStar_StarZLessThanOne_ResetsStarPosition()
        {
            ...
            Assert.That(star.Z, Is.GreaterThanOrEqualTo(1)); // Исправлено
        }
        ...
        public void TimerTick_CallsMoveAndDrawStarMethods()
        {
            ...
            // Act
            timer.Start();
            form.timer1_Tick(null, EventArgs.Empty); // Изменено
        ...
        {
            // Act
            form.Form1_Load(null, EventArgs.Empty); // Изменено
